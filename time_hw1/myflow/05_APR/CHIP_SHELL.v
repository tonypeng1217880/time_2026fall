...
//==================================================================
// OUTPUT PAD: YA2GSD
// Syntax: YA2GSD PAD_NAME (.I(CORE_PIN_NAME), .O(PAD_PIN_NAME), .E(1'b1), .E2(1'b1), .E4(1'b1), .E8(1'b1), .SR(1'b0));
//     Ex: YA2GSD  O_VALID (.I(C_out_valid),   .O(out_valid),    .E(1'b1), .E2(1'b1), .E4(1'b1), .E8(1'b1), .SR(1'b0));
//==================================================================
YA2GSD O_VALID ( .I(C_out_valid), .O(out_valid), .E(1'b1), .E2(1'b1), .E4(1'b1), .E8(1'b1), .SR(1'b0));
